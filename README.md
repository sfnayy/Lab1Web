...
_blank = membuka di tab baru, _self = membuka di tab yang sama, _top = membuka pada jendela penuh, _parent = Membuka tautan pada kerangka induk (parent frame) apabila tautan berada di dalam sebuah frame.
